	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363330969414495@newsletter',
            newsletterName: '𝙈𝙚𝙜𝙖𝙩𝙧𝙤𝙣 𝘽𝙤𝙩 𝙋𝙧𝙤 🤖', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363330969414495@newsletter", "120363330969414495@newsletter", "120363330969414495@newsletter", "120363330969414495@newsletter", "120363330969414495@newsletter"]
let canalNombre = ["𝙈𝙚𝙜𝙖𝙩𝙧𝙤𝙣 𝘽𝙤𝙩 𝙋𝙧𝙤 🤖", "𝙉𝙚𝙭𝙪𝙨 𝙃𝙤𝙨𝙩 𝙋𝙧𝙤 👑", "𝙈𝙚𝙜𝙖𝙩𝙧𝙤𝙣 𝘽𝙤𝙩 𝙋𝙧𝙤 🤖", "𝙉𝙚𝙭𝙪𝙨 𝙃𝙤𝙨𝙩 𝙋𝙧𝙤 👑", "𝙈𝙚𝙜𝙖𝙩𝙧𝙤𝙣 𝘽𝙤𝙩 𝙋𝙧𝙤 🤖"]
