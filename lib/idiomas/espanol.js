...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE MEGATRON 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR MEGATRON 🐈`}
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Megatron Bot Pro `}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Megatron Bot Pro  en Grupos`}
...
const smsConfi2 = () => { return `*Usuario*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Megatron Bot Pro  🐈'}
