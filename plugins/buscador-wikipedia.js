...
conn.reply(m.chat, `${mid.buscador9}\n\n` + res.result.isi, fkontak, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝙁𝙡𝙖𝙨𝙝𝘽𝙤𝙩𝙋𝙧𝙤 | 𝙒𝙞𝙠𝙞𝙥𝙚𝙙𝙞𝙖', body: '𝙁𝙡𝙖𝙨𝙝 𝘽𝙤𝙩 𝙋𝙧𝙤 ⚡', previewType: 0, thumbnail: imagen2, sourceUrl: accountsgb }}})
}).catch((e) => {
