...
*╭━〔 🤖 CANAL OFICIAL 🤖〕*
*┃🤖* https://whatsapp.com/channel/0029VaiHa0GJkK7If3ctDH0g
*╰━━━━━━━━━━━━━*
...
*┃🤖* _${usedPrefix}morse codif*┃🤖*r *texto*_
*┃🤖* _${usedPrefix}morse decodif*┃🤖*r *morse*_
...
*┃🤖* _${usedPrefix}buy_
*┃🤖* _${usedPrefix}sell_
*┃🤖* _${usedPrefix}verif*┃🤖*r | registrar_
...
*┃🤖* _${usedPrefix}comun*┃🤖*r | broadcastall | bc *texto*_
*┃🤖* _${usedPrefix}broadcastchats | bcc *texto*_
*┃🤖* _${usedPrefix}comun*┃🤖*rpv *texto*_
*┃🤖* _${usedPrefix}broadcastgc *texto*_
*┃🤖* _${usedPrefix}comun*┃🤖*rgrupos *texto*_
...
*╰━━━━━━━━━━━━━*
`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, m, fakeChannel, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙈𝙚𝙜𝙖𝙩𝙧𝙤𝙣 𝘽𝙤𝙩 𝙋𝙧𝙤 🤖 ', previewType: 0, thumbnail: imagen4, sourceUrl: canales }}})
...
{ comando: 'comprarbot', descripcion: false, contexto: 'Información y métodos de instalación', showPrefix: true },
{ comando: 'creador , owner', descripcion: false, contexto: 'Información sobre mí Creador', showPrefix: true },
